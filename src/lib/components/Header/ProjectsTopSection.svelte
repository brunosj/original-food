<script lang="ts">
	...
	let svgWidth = $state<number | undefined>(undefined);
...
<section class="sectionPy relative" id="projects" style:background-color="var(--color-ter)">
	<div class="layout space-y-6 lg:space-y-12">
		...
		<div class="absolute bottom-16 right-16 2xl:right-24 opacity-0 lg:opacity-100 overflow-hidden">
			<Map width={svgWidth} />
		</div>
	</div>
</section>
